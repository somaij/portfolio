...
!function (a, b) {
  "function" == typeof define && define.amd ? define([], b) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = b : a.conditionizr = b();
}(void 0, function () {
  "use strict";
  ...
  return b.config = function (c) {
    ...
    for (var g in f) {
      var h = g.toLowerCase();
      if (b[h]) for (var i = f[g], j = i.length; j--;) {
        d(h, i[j]);
      }
    }
  }, b.add = function (a, c, e) {
    var f = a.toLowerCase();
    if (b[f] = e(), b[f]) for (var g = c.length; g--;) {
      d(f, c[g]);
    }
  }, b.on = function (a, c) {
    var d = /^\!/;
